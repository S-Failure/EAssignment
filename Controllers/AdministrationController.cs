    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            else
            {
                ...
                var result2 = await userManager.RemoveFromRolesAsync(user, roles);
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    { 
                        ...
                        if (model.Roles[i].IsSelectedRole)
                        {
                            result1 = await userManager.AddToRoleAsync(user, model.Roles[i].RoleName);
                        }
                        else
                        {
                            continue;
